...
Huge icon libraries converted from `.svg` to `.png` to use as custom button icons on Fifine D6 Streamcontroller — more than 40k icons available in different colors for any streamcontroller setup.
### Icon Libraries Used
